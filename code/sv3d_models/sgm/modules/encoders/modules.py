...
class GeneralConditioner(nn.Module):
    ...
    def __init__(self, emb_models: Union[List, ListConfig]):
        ...
        for n, embconfig in enumerate(emb_models):
            ...
            # ------------------------ debug; check how azimuths_rad embedder is defined -------------------------------
            # if embconfig["input_key"] == "azimuths_rad":
            #
        ...
        for embedder in self.embedders:
            ...
            with embedding_context():
                if hasattr(embedder, "input_key") and (embedder.input_key is not None):
                    ...
                    # ------------------------- debug; check how azimuths_rad turns into embeddings --------------------
                    # if embedder.input_key == "azimuths_rad":
                    #     debug_embedder_inputs = batch[embedder.input_key]
                    #     debug_embedder_outputs = embedder(debug_embedder_inputs)
                    #     print()
                    #
                    #     # debugging records
                    #
                    #     # order reversed (360° minus ....)
                    #     # tensor([[9.5557e-01, 8.7242e-01, 7.5532e-01, ..., 6.6660e-04, 6.4304e-04,
                    #     #          6.2032e-04],
                    #     #         [8.2624e-01, 6.9722e-01, 5.4611e-01, ..., 6.3327e-04, 6.1089e-04,
                    #     #          5.8930e-04],
                    #     #         [6.2349e-01, 4.6433e-01, 2.9484e-01, ..., 5.9994e-04, 5.7874e-04,
                    #     #          5.5829e-04],
                    #     #         ...,
                    #     #         [8.2624e-01, 8.3797e-01, 8.4892e-01, ..., 6.6660e-05, 6.4304e-05,
                    #     #          6.2032e-05],
                    #     #         [9.5557e-01, 9.5864e-01, 9.6149e-01, ..., 3.3330e-05, 3.2152e-05,
                    #     #          3.1016e-05],
                    #     #         [1.0000e+00, 1.0000e+00, 1.0000e+00, ..., 0.0000e+00, 0.0000e+00,
                    #     #          0.0000e+00]], device='cuda:0')
                    #
                    #     # order default
                    #     # tensor([[9.5557e-01, 9.5864e-01, 9.6149e-01, ..., 3.3330e-05, 3.2152e-05,
                    #     #          3.1016e-05],
                    #     #         [8.2624e-01, 8.3797e-01, 8.4892e-01, ..., 6.6660e-05, 6.4304e-05,
                    #     #          6.2032e-05],
                    #     #         [6.2349e-01, 6.4797e-01, 6.7097e-01, ..., 9.9990e-05, 9.6457e-05,
                    #     #          9.3048e-05],
                    #     #         ...,
                    #     #         [8.2624e-01, 6.9722e-01, 5.4611e-01, ..., 6.3327e-04, 6.1089e-04,
                    #     #          5.8930e-04],
                    #     #         [9.5557e-01, 8.7242e-01, 7.5532e-01, ..., 6.6660e-04, 6.4304e-04,
                    #     #          6.2032e-04],
                    #     #         [1.0000e+00, 1.0000e+00, 1.0000e+00, ..., 0.0000e+00, 0.0000e+00,
                    #     #          0.0000e+00]], device='cuda:0')
                    # --------------------------------------------------------------------------------------------------
            ...
            for emb in emb_out:
                ...
                if out_key in output:
                    ...
                    output[out_key] = emb
        return output  # {[1,1,1024], [1,4,72,72], [21,1280]}
    ...
    def get_conditional_conditioning(
        self,
        batch_c: Dict,
        force_cond_zero_embeddings: Optional[List[str]] = None,
    ):
...
class FrozenOpenCLIPEmbedder2(AbstractEmbModel):
    ...
    def __init__(
        ...
        model, _, _ = open_clip.create_model_and_transforms(
            ...
            pretrained="/home/disk2/SSCPCtrl_assets/PRETRAINS/CLIP-ViT-H-14-laion2B-s32B-b79K/open_clip_pytorch_model.bin",
        )
        del model.visual
        self.model = model
